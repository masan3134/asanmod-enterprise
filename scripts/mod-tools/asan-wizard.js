...
/**
 * 🧙‍♂️ ASANMOD v3.0.0-alpha: First-Run Wizard
...
function createLock(projectName, modules) {
  ...
  const lock = {
    ...
    version: '2.1.0-alpha',
    modules,
    protocol: 'ASANMOD v3.0.0-alpha Wizard',
  };
...
async function runWizard() {
  ...
  header('🧙 ASANMOD v3.0.0-alpha WIZARD');
  ...
  🛡️ ASANMOD v3.0.0-alpha - Iron Curtain Active
  `, COLORS.green);
